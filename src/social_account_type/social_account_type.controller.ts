...
import { SocialAccountTypeService as EntityService } from './social_account_type.service';

@ApiTags('SocialAccountType')
@Controller('social_account_type')
export class SocialAccountTypeController {
